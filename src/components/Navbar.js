        ...
        <div className='flex justify-between items-center border-b-2 border-gray-100 py-4 md:space-x-10'>
          ...
          <nav className='hidden md:flex space-x-10'>
            <div className='relative'>
              ...
              <button
                type='button'
                className='font-bold tracking-wider uppercase text-blue-900 group inline-flex items-center space-x-2 text-base leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150'
